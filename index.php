...
if (isset($_POST['add_to_cart'])) {
    if (!isset($user_id)) {
        ...
        if (mysqli_num_rows($select_book) > 0) {
            $message[] = 'This Foods is alredy in your cart';
        } else {
            ...
            $message[] = 'Foods Added To Cart Successfully';
...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100 " src="images/galary7.jpeg" alt="First slide">
            </div>

        <div class="carousel-item">
                <img class="d-block w-100" src="images/galary8.jpeg" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="images/galary2.jpg" alt="Third slide">
            </div>
        </div>
    ...
    <section id="New">
        ...
        <div class="container px-5 mx-auto">
            <h2 class="m-8 font-extrabold text-4xl text-center border-t-2 " style="color: red;">
                South Indian
            </h2>
        </div>
    </section>
            ...
            ?>
                    ...
                    <div class="box" style="width: 255px; height:355px;">
                        <a href="book_details.php?details=<?php echo $fetch_book['bid'];
                                                            echo '-name=', $fetch_book['name']; ?>"> <img style="height: 200px;width: 220px;margin: auto;" class="books_images" src="added_books/<?php echo $fetch_book['image']; ?>" alt=""></a>
    ...
    <section id="Adventure">
        ...
        <div class="container px-5 mx-auto">
            <h2 class="text-gray-400 m-8 font-extrabold text-4xl text-center border-t-2 text-red-800" style="color: red;" >
         <!--  Biryani-->
            </h2>
        </div>
    </section>
    ...
    <section id="Magical">
        ...
        <div class="container px-5 mx-auto">
            <h2 class="text-gray-400 m-8 font-extrabold text-4xl text-center border-t-2 text-red-800"style="color: green;">
            Chicken
            </h2>
        </div>
    </section>
    <section class="show-products">
        <div class="box-container">
            ...
            ?>
                    ...
                    <div class="box" style="width: 255px;height: 355px;">
                        <a href="book_details.php?details=<?php echo $fetch_book['bid'];
                                                            echo '-name=', $fetch_book['name']; ?>"> <img style="height: 200px;width: 260px;margin: auto;" class="books_images" src="added_books/<?php echo $fetch_book['image']; ?>" alt=""></a>
                        <div style="text-align:left ;">
