  ...
  <body >
    ...
    <div class="main_box">
      ...
      <?php
        ...
        <img class="card-img-top" src="./images/pen4.jpg" alt="Card image cap" /> 
        <div class="card-body">
      ...
      <?php
         ...
         ?>
        <img class="card-img-top" src="./images/com.jpg" alt="Card image cap" />
        <div class="card-body">
      ...
      <div class="card" style="width: 15rem">
        <img class="card-img-top" src="./images/Butter-Masala-Dosa.png" alt="Card image cap" />
        <div class="card-body">
          <h5 class="card-title">Number Of Available Items</h5>
          <p class="card-text">
          <?php echo $bookscount; ?>
          </p>
          <div class="buttons" style="display: flex;">
          <a href="total_foods.php" class="btn btn-primary">See Food Items</a>
          <a href="add_foods.php" class="btn btn-primary">Add Food Items</a>
          </div>
        </div>
      </div>
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Number Of Comments by Users</h5>
          <p class="card-text">
          <?php echo $msgcount; ?>
          </p>
      ...
      <div class="card" style="width: 15rem">
        <img class="card-img-top" src="./images/admin-logo.jpg" alt="Card image cap" />
        <div class="card-body">
      ...
      <div class="card" style="width: 15rem">
        <img class="card-img-top" src="./images/user-logo.jpg" alt="Card image cap" />
        <div class="card-body">
