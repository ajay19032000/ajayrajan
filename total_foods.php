...
if(isset($_GET['delete'])){
  ...
  header('location:total_foods.php');
}
...
<body>
  ...
  ?>
<a class="update_btn" style="position: fixed ; z-index:100;" href="add_foods.php">Add More Foods</a>
  ...
  <section class="show-products">
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="name">Food : <?php echo $fetch_book['title']; ?></div>
         <div class="name">Name: <?php echo $fetch_book['name']; ?></div>
         <div class="price">Price: ₹ <?php echo $fetch_book['price']; ?>/-</div>
         <a href="total_foods.php?update=<?php echo $fetch_book['bid']; ?>" class="update_btn">update</a>
         <a href="total_foods.php?delete=<?php echo $fetch_book['bid']; ?>" class="delete_btn" onclick="return confirm('delete this product?');">delete</a>
      </div>
      <?php
         }
      }else{
